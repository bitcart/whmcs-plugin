...
/**
 * BitcartCC Checkout Callback 3.0.1.7
 *
...
$success = true;
$invoiceId = $all_data->order_id;
$transactionId = $all_data->id;
$paymentAmount = $all_data->price;
...
#update the tblinvoices table
    ...
    $where = array("id" => $all_data->order_id, "paymentmethod" => "bitcartcheckout");
    update_query($table, $update, $where);

#update the _bitcart_transactions table
    $table = "_bitcart_checkout_transactions";
    $update = array("transaction_status" => "paid", "updated_at" => date("Y-m-d H:i:s"));
    $where = array("order_id" => $all_data->order_id, "transaction_id" => $transactionId);
    update_query($table, $update, $where);

#delete any orphans
    $table = "_bitcart_checkout_transactions";
    $delete = 'DELETE FROM _bitcart_checkout_transactions WHERE order_id = "' . $all_data->order_id . '" AND transaction_status = "new"';
    full_query($delete);
